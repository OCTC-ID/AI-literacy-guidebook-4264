...
pages/
  ...
  appendix-b.html             Appendix B: The BE Framework at OCTC (draft, OCTC-specific)
```
...
4. Replace or remove Appendix B, which maps the playbook to OCTC's college-wide framework. Add your own campus-specific material (local policies, program examples, crosswalks) as a separate appendix like this one, so the core pages stay easy to update.
